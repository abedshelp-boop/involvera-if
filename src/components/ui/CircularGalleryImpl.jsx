// @ts-nocheck
/* eslint-disable */
// CircularGallery from ReactBits - uses OGL WebGL library
// Kept as JSX due to OGL lacking TypeScript types
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = Array.from({ length: 12 }, (_, i) => ({ image: `https://picsum.photos/seed/${i + 1}/800/600?grayscale`, text: `Image ${i + 1}` }));
